...
public class BitCoin {
    ...
    private List<String> coluna8;
    private List<String> coluna9;
    ...
    public BitCoin() {
        ...
        this.coluna8 = new ArrayList<>();
        this.coluna9 = new ArrayList<>();
    }
    ...
    public List<String> getColuna8() {
        return coluna8;
    }

    public List<String> getColuna9() {
        return coluna9;
    }
}